...
### Features
- **collateral:** Remove the fixed mirror-coin collateral constants (#19)

## [0.12.0] - 2026-08-27

### Features
- **mirror-coin:** Canonical collateral amount and 7-day epoch clock (#18)

## [0.11.2] - 2026-08-26

### Chores
- **deps:** Adopt the chia-sdk-types 0.36.0 ceiling (#16)

## [0.11.1] - 2026-08-24

### Documentation
- **relay:** Stale :9450 comments contradicted the :443 constant beside them (#15)

## [0.11.0] - 2026-08-22

### Features
- **bootstrap:** Canonical always-on peer anchors (DIG_BOOTSTRAP_PEERS) (#14)

## [0.10.1] - 2026-08-10

### Testing
- **genesis:** Independent literal pin for genesis + AGG_SIG domains (#12)

## [0.10.0] - 2026-08-04

### Features
- **deps:** Migrate to the chia-0.36 / sdk-types-0.34 family

## [0.9.0] - 2026-08-02

### Features
- **constants:** Add PROFILE_SEALING_X25519_LABEL for the per-profile X25519 sealing key (#10)

## [0.8.0] - 2026-07-22

### Features
- **constants:** Hoist §5.3 read-ladder endpoints (dig.local, rpc.dig.net) (#9)

## [0.7.0] - 2026-07-20

### Features
- **constants:** Per-profile DEK at-rest byte-contract constants (#8)
